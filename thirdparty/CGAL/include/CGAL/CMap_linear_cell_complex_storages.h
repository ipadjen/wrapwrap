...
//
// $URL: https://github.com/CGAL/cgal/blob/v6.0-dev/Linear_cell_complex/include/CGAL/CMap_linear_cell_complex_storages.h $
// $Id: include/CGAL/CMap_linear_cell_complex_storages.h a484bfa $
...
namespace CGAL {
  ...
  public:
   ...
   /** Return if this dart is free for adimension.
    ...
    bool is_free(Dart_const_descriptor dh) const
    {
      ...
      return dh->mf[i]==null_dart_descriptor;
    }
  ...
  protected:
    ...
    /// Container for the null_dart_descriptor.
