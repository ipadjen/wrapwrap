...
//
// $URL: https://github.com/CGAL/cgal/blob/v6.0-dev/Surface_mesh_simplification/include/CGAL/Surface_mesh_simplification/internal/Edge_collapse.h $
// $Id: include/CGAL/Surface_mesh_simplification/internal/Edge_collapse.h a484bfa $
...
public:
  ...
  typedef ShouldIgnore_                                                   Should_ignore;
...
public:
  EdgeCollapse(Triangle_mesh& tmesh,
               ...
               const Should_ignore& should_ignore,
               Visitor visitor);
