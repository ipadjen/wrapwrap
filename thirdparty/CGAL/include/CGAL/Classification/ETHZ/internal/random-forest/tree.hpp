...
//
// $URL: https://github.com/CGAL/cgal/blob/v6.0-dev/Classification/include/CGAL/Classification/ETHZ/internal/random-forest/tree.hpp $
// $Id: include/CGAL/Classification/ETHZ/internal/random-forest/tree.hpp a484bfa $
