...
//
// $URL: https://github.com/CGAL/cgal/blob/v6.0-dev/Combinatorial_map/include/CGAL/Combinatorial_map_basic_operations.h $
// $Id: include/CGAL/Combinatorial_map_basic_operations.h a484bfa $
...
namespace CGAL
{
  ...
  typename Map::size_type degree(const Map & amap,
                                 typename Map::Dart_const_descriptor adart)
  {
    CGAL_assertion(adart!=amap.null_descriptor);
