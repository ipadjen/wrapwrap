...
//
// $URL: https://github.com/CGAL/cgal/blob/v6.0-dev/Shape_detection/include/CGAL/Shape_detection/Region_growing/Point_set/Least_squares_sphere_fit_sorting.h $
// $Id: include/CGAL/Shape_detection/Region_growing/Point_set/Least_squares_sphere_fit_sorting.h a484bfa $
...
using Least_squares_sphere_fit_sorting_for_point_set =
  Least_squares_sphere_fit_sorting<typename Kernel_traits<typename PointSet3::Point_3>::Kernel,
...
make_least_squares_sphere_fit_sorting(const PointSet3& ps,
                                        NeighborQuery& neighbor_query,
                                        const CGAL_NP_CLASS np = parameters::default_values())
{
  return Least_squares_sphere_fit_sorting_for_point_set<PointSet3,NeighborQuery>
