...
//
// $URL: https://github.com/CGAL/cgal/blob/v6.0-dev/Nef_3/include/CGAL/Nef_3/Exact_triangulation_euclidean_traits_xy_3.h $
// $Id: include/CGAL/Nef_3/Exact_triangulation_euclidean_traits_xy_3.h a484bfa $
...
struct Exact_intersect_xy_2 <R,Cartesian_tag>
{
  ...
  operator() (const Segment_3& s3, const Segment_3& t3)
   {  Point_2 p2, q2;
      ...
      return std::make_optional(variant_type(Segment_3(Point_3(p2.x(),p2.y(),0),
                                                         Point_3(q2.x(),q2.y(),0) ) ));
   }
};
...
{  // Homogeneous
   ...
   {  Point_2 p2, q2;
      ...
      return std::make_optional(variant_type(Segment_3(Point_3 (p2.hx(),p2.hy(),0,p2.hw()),
