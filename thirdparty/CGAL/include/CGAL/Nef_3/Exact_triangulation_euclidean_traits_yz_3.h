...
//
// $URL: https://github.com/CGAL/cgal/blob/v6.0-dev/Nef_3/include/CGAL/Nef_3/Exact_triangulation_euclidean_traits_yz_3.h $
// $Id: include/CGAL/Nef_3/Exact_triangulation_euclidean_traits_yz_3.h a484bfa $
...
struct Exact_intersect_yz_2 <R,Cartesian_tag>
{
   ...
   {  Point_2 p2, q2;
      ...
      {
        return std::make_optional(variant_type(Point_3(0,p2.x(),p2.y())));
      }
      ...
      return std::make_optional(variant_type(Segment_3(Point_3(0,p2.x(),p2.y()),
                                                         Point_3(0,q2.x(),q2.y()) ) ));
   }
};
...
{  // Homogeneous
   ...
   {  Point_2 p2, q2;
      ...
      if (const Point_2* pi =  std::get_if<Point_2>(&*obj))
      {
        return std::make_optional(variant_type(Point_3(0,p2.hx(),p2.hy(),p2.hw())));
      }
      ...
      return std::make_optional(variant_type(Segment_3(Point_3 (0,p2.hx(),p2.hy(),p2.hw()),
